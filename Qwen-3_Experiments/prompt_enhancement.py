...
merged_df_cards = pd.concat(
    [df_cards_train[["text", "claim"]], df_cards_valid[["text", "claim"]], df_cards_test[["text", "claim"]]],
    ignore_index=True
)
...
You will be given a single claim. Your task is to classify the claim by assigning the most appropriate narrative ID(s) from
the Narratives_list below.
...
Example 2
Claim: "According to a recent study, there's no link between CO2 emissions and temperature changes in our lifetime. #ClimateChange
#Science"
Narrative IDs: 2_3

Example 3
Claim: "Turns out, species that can adapt easily to different environments are often the ones that can survive in a wide variety of
places."
Narrative IDs: 0_0
...
df_submission["narrative"] = test_predictions
